...
__decorate([
    (0, class_validator_1.IsDateString)({}, { message: 'Birthdate must be a valid date in ISO 8601 format' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Birthdate is required' }),
    __metadata("design:type", String)
], CreateUserDto.prototype, "dateOfBirth", void 0);
__decorate([
    (0, class_validator_1.IsEnum)(Role_enum_1.Role, { message: 'Invalid role selected' }),
